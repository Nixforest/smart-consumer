...
public class Bill {
     ...
     */
    public Bill(String customerName, String customerEmail, String customerPhone, String customerAddress, int payment,
            String cardNumber, String holderName, Date expirationDate) {
